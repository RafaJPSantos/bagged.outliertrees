...
This package is only compatible with `outliertree` versions <= 1.2.0. One of the main differences is that it does not support missing values: if not taken care of, rows with missing values are automatically removed while fitting the model or predicting on new data.
